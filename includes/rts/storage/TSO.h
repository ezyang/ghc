...
typedef struct StgTSO_ {
    ...
    */
    ...
    StgWord64 ss_pass;
    // These are bounded above by STRIDE1, which is less than max 32-bit word.
    // You must take out the sched_lock to write to these; reads are OK
    StgWord ss_tickets, ss_stride, ss_remain;
