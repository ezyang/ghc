...
generate directory distdir dll0Modules config_args
 ...
 $ do let verbosity = normal
      ...
      let
          ...
          -- TODO: get rid of lib names and package keys from here
          depLibNames
      ...
      let xs = [variablePrefix ++ "_VERSION = " ++ display (pkgVersion (package pd)),
                ...
                variablePrefix ++ "_PACKAGE_KEY = " ++ display (localInstalledPackageId lbi),
                -- copied from mkComponentsLocalBuildInfo
                variablePrefix ++ "_LIB_NAME = " ++ display (localInstalledPackageId lbi),
