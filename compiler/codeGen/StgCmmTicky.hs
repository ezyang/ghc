    ...
    register_stmts
      = [ mkStore (CmmLit (cmmLabelOffB ctr_lbl (oFFSET_StgEntCounter_link dflags)))
        ...
        , mkStore (CmmLit (cmmLabelOffB ctr_lbl
                   ...
                   (mkIntExpr dflags 1) ]
    ticky_entry_ctrs = mkLblExpr (mkCmmDataLabel rtsUnitKey (fsLit "ticky_entry_ctrs"))
...
bumpTickyCounter lbl = bumpTickyLbl (mkCmmDataLabel rtsUnitKey lbl)

bumpTickyCounterBy :: FastString -> Int -> FCode ()
bumpTickyCounterBy lbl = bumpTickyLblBy (mkCmmDataLabel rtsUnitKey lbl)

bumpTickyCounterByE :: FastString -> CmmExpr -> FCode ()
bumpTickyCounterByE lbl = bumpTickyLblByE (mkCmmDataLabel rtsUnitKey lbl)
