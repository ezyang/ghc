...
newtype PackageConfigMap = PackageConfigMap { unPackageConfigMap :: InstalledUnitIdMap PackageConfig }
...
lookupInstalledPackage' (PackageConfigMap db) uid = lookupUDFM db uid
