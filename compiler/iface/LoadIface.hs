...
-- | Generalized version of 'computeInterface', this finds either the definite
-- or indefinite interface for a module, and then runs 'def_action' or
-- 'indef_action' depending on which it found.
computeInterfaceAnd ::
       (ModIface -> a)
